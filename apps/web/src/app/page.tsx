            ...
            <div className="overflow-hidden rounded-[24px] border border-[#DDD5FF] bg-white shadow-[0_25px_70px_rgba(60,39,140,.18)]">
                ...
                <div className="grid min-h-[470px] grid-cols-[128px_1fr]">
                    <aside className="border-r border-[#ECEEF2] bg-[#FCFBFF] p-3">
                        <div className="mb-4 text-[8px] font-semibold tracking-[0.12em] text-[#98A2B3] uppercase">
                            Prepare
                        </div>
                        {[
                            'Dashboard',
                            ...
                            <div
                                ...
                                className={`mb-1 rounded-md px-2 py-2 text-[9px] ${
                                    i === 0
                                        ? 'bg-[#F3F0FF] font-semibold text-[#6D4AFF]'
                                        : 'text-[#667085]'
                                }`}
                            >
                                {item}
                        ...
                        <div className="mt-4 mb-2 text-[8px] font-semibold tracking-[0.12em] text-[#98A2B3] uppercase">
                            Career
                        </div>
                        {['CV', 'Job Descriptions', 'CV-JD Matching'].map(
                            (item) => (
                                <div
                                    key={item}
                                    className="mb-1 rounded-md px-2 py-2 text-[9px] text-[#667085]"
                                >
                                    {item}
                                </div>
                            ),
                        ...
                        {['Reports', 'Skills & Progress', 'Learning Plan'].map(
                            (item) => (
                                <div
                                    key={item}
                                    className="mb-1 rounded-md px-2 py-2 text-[9px] text-[#667085]"
                    ...
                    <section className="bg-[#F8F9FC] p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="rounded-xl border border-[#E5E7EB] bg-white p-4">
                                ...
                                <div className="mt-3 rounded-lg border border-[#ECEEF2] p-3">
                                    ...
                                    <div className="mt-1 text-[8px] text-[#667085]">
                        ...
                        <div className="mt-3 rounded-xl border border-[#E5E7EB] bg-white p-4">
                            <div className="mb-3 text-[9px] font-semibold text-[#667085]">
                                Your progress
                            </div>
                            <div className="grid grid-cols-4 gap-2">
                                {[
                                    ...
                                    <div
                                        key={label}
                                        className="rounded-lg border border-[#ECEEF2] p-3 text-center"
                                    >
                                        <div className="text-[15px] font-bold text-[#6D4AFF]">
                                            {value}
                                        </div>
                                        <div className="mt-1 text-[7px] leading-3 text-[#667085]">
                                            {label}
                                        </div>
                                    </div>
                                ))}
                        ...
                        <div className="mt-3 rounded-xl border border-[#E5E7EB] bg-white p-4">
                            <div className="mb-3 flex items-center justify-between">
                                ...
                                <span className="text-[8px] font-semibold text-[#6D4AFF]">
                                    View all activity →
                                </span>
                            </div>
                            {[
                                [
                                    'Completed Frontend Developer Interview',
                                    'Score: 85%',
                                    '2 hours ago',
                                ],
                                [
                                    'Improved in React.js',
                                    '+15% progress',
                                    '1 day ago',
                                ],
                                [
                                    'Added 5 new questions to practice',
                                    '',
                                    '3 days ago',
                                ],
                            ].map(([title, meta, time]) => (
                                <div
                                    key={title}
                                    className="flex items-center justify-between border-t border-[#F0F1F4] py-2 first:border-t-0"
                                >
                                    <div className="flex items-center gap-2">
    ...
    return (
        <main className="bg-white text-[#111827]">
            <header className="sticky top-0 z-50 border-b border-[#ECEEF2] bg-white/95 backdrop-blur">
                <div className="mx-auto flex h-[64px] max-w-[1440px] items-center justify-between px-6 lg:px-10">
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            href="/sign-in"
                            className="hidden rounded-lg px-4 py-2.5 text-sm font-semibold text-[#111827] hover:bg-[#F8F9FC] sm:inline-flex"
                        >
                            Sign in
                        </Link>
                        <Link
            ...
            <section className="relative overflow-hidden bg-[radial-gradient(circle_at_75%_20%,rgba(109,74,255,.08),transparent_35%),linear-gradient(180deg,#FCFBFF_0%,#FFFFFF_72%)]">
                <div className="mx-auto grid max-w-[1440px] items-center gap-12 px-6 pt-16 pb-16 lg:grid-cols-[.78fr_1.22fr] lg:px-10 lg:pt-18 lg:pb-20">
                    <div className="max-w-[560px]">
                        ...
                        <h1 className="mt-6 text-[58px] leading-[1.02] font-extrabold tracking-[-0.045em] text-[#111827]">
                            Practice smarter.
                        ...
                        <p className="mt-7 max-w-[530px] text-[17px] leading-8 text-[#667085]">
                            Interviewly helps you ace your interviews with
                            AI-powered practice, real-time feedback, and a
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-1 text-[10px] leading-4 text-[#667085]">
                                                {text as string}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="mx-auto max-w-[1240px] px-6 pb-8 lg:px-10">
                    <p className="mb-5 text-center text-xs font-medium text-[#667085]">
                        Trusted by ambitious job seekers preparing for their
                        next opportunity
                    </p>
            ...
            <section
                id="how-it-works"
                className="scroll-mt-24 border-t border-[#ECEEF2] py-16"
            >
                <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-[#667085]">
                            Get better at interviews in 4 simple steps
                        </p>
                    </div>
                        ...
                        {howItWorks.map((item, i) => (
                            ...
                            >
                                ...
                                {i < howItWorks.length - 1 && (
                                    <ChevronRight className="absolute top-1/2 -right-4 hidden size-6 -translate-y-1/2 text-[#6D4AFF] xl:block" />
                                )}
                            </div>
                        ))}
                    </div>
            ...
            <section id="ai-feedback" className="scroll-mt-24 py-16">
                <div className="mx-auto grid max-w-[1240px] items-center gap-12 px-6 lg:grid-cols-[1.1fr_.9fr] lg:px-10">
                            ...
                            <div className="grid grid-cols-[160px_1fr] gap-6">
                                <div>
                                    ...
                                    <p className="mt-1 text-xs leading-5 text-[#667085]">
                                        You performed better than 80% of users.
                                    </p>
                                </div>

                                <div>
                                    <div className="text-xs font-semibold tracking-[0.12em] text-[#667085] uppercase">
                                        Strengths
                                    </div>
                                    ...
                                    <div className="mt-5 text-xs font-semibold tracking-[0.12em] text-[#667085] uppercase">
                                        Areas to improve
                                    </div>
                                    <div className="mt-3 flex flex-wrap gap-2">
                                        {[
                                            ...
                                            <span
                                                key={item}
                                                className="rounded-full bg-[#F3F0FF] px-3 py-1 text-xs font-medium text-[#6D4AFF]"
                                            >
                                                {item}
                                            </span>
                                        ))}
                    ...
                    <div>
                        <div className="inline-flex rounded-full bg-[#F3F0FF] px-3 py-1.5 text-[11px] font-bold tracking-[0.12em] text-[#6D4AFF] uppercase">
                            AI Feedback that matters
                        </div>
                        <h2 className="mt-5 text-[42px] leading-[1.05] font-bold tracking-[-0.04em]">
                            Know your strengths.
                            <br />
                            Improve your weaknesses.
                        </h2>
                        <p className="mt-5 max-w-xl text-base leading-7 text-[#667085]">
                            Interviewly gives you detailed feedback and insights
            ...
            <section className="px-6 pb-5 lg:px-10">
                <div className="mx-auto flex max-w-[1240px] flex-col items-center justify-between gap-6 rounded-[22px] bg-[linear-gradient(100deg,#4E1FEA_0%,#6D4AFF_58%,#8758FF_100%)] px-8 py-7 text-white md:flex-row">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Link
                            href="/sign-up"
                            className="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-3 text-sm font-semibold text-[#5B3DEB]"
                        >
                            Start practicing free
                            <ArrowRight className="size-4" />
                        </Link>
                    ...
                    <div className="grid gap-10 md:grid-cols-[1.25fr_repeat(4,1fr)]">
                        <div>
                            ...
                            <p className="mt-4 max-w-xs text-xs leading-5 text-[#667085]">
                                AI-powered interview preparation platform to
                                help you practice smarter and get hired faster.
                            </p>
