/*
  ...
  - The values [BEGINNER,INTERMEDIATE,ADVANCED,EXPERT] on the enum `experience_level_enum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "experience_level_enum_new" AS ENUM ('INTERN', 'FRESHER', 'JUNIOR', 'MIDDLE', 'SENIOR', 'LEAD');
